...
def ensure_employee_schema():
    """Create branches and employees tables if not exist. Seed basic rows."""
...
def create_employee(data: Dict[str, Any]) -> int:
    ...
    Expects keys: full_name, national_id, password, role, branch_id, phone, address, monthly_salary, status
    """
    ...
    cur.execute(
        ...
        INSERT INTO employees
            (full_name, national_id, password, role, branch_id, phone, address, monthly_salary, status)
